...
(function () {
  ...
  var MOODS = {
    ...
    sunset: { name: 'Sunset', exp: 0.82, sun: { c: 0xff7a1e, i: 2.3 }, amb: { c: 0x40287a, i: 0.14 }, hemi: { s: 0xff9450, g: 0x100a32, i: 0.5 }, rim: { c: 0xffcf4a, i: 2.6 }, fill: { c: 0x3a4cff, i: 0.6 }, fog: 0x1a0e30, grade: { sat: 1.64, sep: 0, shad: [0.72, 0.82, 1.3], high: [1.3, 1.0, 0.6], lo: 0.1, hi: 0.84, con: 1.32, bright: 0.7, lift: 0.45, gmAmt: 0.88, gm: [[0.08, 0.04, 0.5], [1.0, 0.36, 0.06], [1.0, 0.86, 0.5]] }, ca: 0.0042, grain: 0.09, vig: 0.58, refl: 2.7, lights: 'prism', prismCols: [0xff2a86, 0xff1fc0, 0xffa024, 0xff5a1e, 0x8a30ff], prismI: 5.4 },   // PUSHED TOO FAR (dark base so the LAYERS show): DEEP blue-purple shadows → blazing orange mids → hot-gold highlights (gmAmt 0.88), blooming gold rim, OVERSATURATED, strong orbiting pink/magenta/gold/orange/violet pools, near-mirror ball   // PUSHED TOO FAR: blazing golden sun + blooming gold rim, DEEP blue-purple shadows vs blazing orange mids vs hot-gold highlights (gmAmt 0.88), OVERSATURATED, strong orbiting pink/magenta/gold/orange/violet light pools, near-mirror reflective ball   // SPECTACULAR LAYERED SUNSET: golden low sun KEY + pink sky-glow fill + COOL blue-purple rim (warm/cool contrast) + warm-sky→cool-ground hemi gradient + cool-purple→orange→gold gradient map + orbiting warm sunset lights for layered colour & glints; boosted reflections so the ball catches it all
  ...
  var FXLAYERS = {
    ...
    sunset:    { src: 'bokeh-gold',     op: 0.3 },    // golden-hour bokeh — pushed: a real dreamy glow layer
