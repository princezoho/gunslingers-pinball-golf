...
(function () {
  ...
  function applyMood(name) {
    ...
    if (R3.r.toneMapping) R3.r.toneMappingExposure = m.exp * 0.82;   // CINEMATIC baseline: underexpose ~a third+ of a stop on EVERY mood (owner: "lower f-stop, underexpose a drop"). 0.80 is the floor before night/prismatic crush — per-mood lighting carries the drama, this just sets the f-stop feel
