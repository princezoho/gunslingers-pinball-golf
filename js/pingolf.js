...
(function () {
  ...
  var BUILD = 'BUILD 203 · STEPPING STONES';

  /* ================================================================ HOLE BUILDER
     A tiny DSL: each hole function fills a builder with obstacles and returns it. */
  function builder() {
    var b = {
      walls: [], bumpers: [], boosters: [], flippers: [], windmills: [], lasers: [], loops: [], warps: [], portals: [], firerings: [], enemies: [], coins: [], powerups: [], spinners: [], cannons: [], bouncers: [], gates: [], conveyors: [], multiball: null,
  ...
  function edClearAll() {   // wipe all placed obstacles/items but keep the level shape (walls), tee, cup, bounds, theme
    ...
    ['bumpers', 'boosters', 'flippers', 'windmills', 'lasers', 'gates', 'conveyors', 'loops', 'warps', 'portals', 'firerings', 'enemies', 'coins', 'powerups'].forEach(function (k) { d[k] = []; });
