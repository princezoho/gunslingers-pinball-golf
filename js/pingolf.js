...
(function () {
  ...
  function initGL(canvas) {
    ...
    try {
      ...
      var sc = sun.shadow.camera; sc.near = 100; sc.far = 5200; sc.left = -1500; sc.right = 1500; sc.top = 1500; sc.bottom = -1500;   // wider frustum so the LONG raking golden-hour shadows (low sun, see sunOff) don't clip
      ...
      var rim = new T.DirectionalLight(0xbfe0ff, 0.6); rim.position.set(650, 760, 1050); R3.scene.add(rim); R3.rim = rim; var fill = new T.DirectionalLight(0xffcf8a, 0.28); fill.position.set(700, 380, -200); R3.scene.add(fill); R3.fill = fill; var spot = new T.SpotLight(0xfff0e0, 0, 2000, 0.55, 0.88, 0); spot.position.set(0, 1500, -160); R3.scene.add(spot.target); R3.scene.add(spot); R3.spot = spot; R3.spotBase = 0; R3.sunOff = { x: -1240, y: 540, z: -720 };   // cool back-rim + warm low fill + a theatrical SPOTLIGHT. LOW raking sun (~20deg elevation) = long dramatic golden-hour shadows across the green (was y760/~33deg = short flat shadows)
