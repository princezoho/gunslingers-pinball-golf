...
(function () {
  ...
  var MOODS = {
    ...
    sunset: { name: 'Sunset', exp: 1.2, sun: { c: 0xff9636, i: 2.1 }, amb: { c: 0xffc096, i: 0.15 }, hemi: { s: 0xffb27e, g: 0x1c1640, i: 0.6 }, rim: { c: 0xffc24a, i: 1.9 }, fill: { c: 0x6a86ff, i: 0.5 }, fog: 0xd2864a, grade: { sat: 1.34, sep: 0, shad: [0.8, 0.88, 1.2], high: [1.2, 1.0, 0.72], lo: 0.14, hi: 0.8, con: 1.24, bright: 0.95, lift: 0.8, gmAmt: 0.54, gm: [[0.12, 0.09, 0.44], [0.97, 0.44, 0.2], [1.0, 0.86, 0.64]] }, ca: 0.003, grain: 0.1, vig: 0.5, refl: 2.0, lights: 'prism', prismCols: [0xffa838, 0xff5a30, 0xff3a82, 0xffc66a, 0x9a48d8], prismI: 3.4 },   // SPECTACULAR LAYERED SUNSET: golden low sun KEY + pink sky-glow fill + COOL blue-purple rim (warm/cool contrast) + warm-sky→cool-ground hemi gradient + cool-purple→orange→gold gradient map + orbiting warm sunset lights for layered colour & glints; boosted reflections so the ball catches it all
